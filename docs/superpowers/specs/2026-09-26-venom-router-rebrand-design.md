...
- Model Pool: "Every model your connected providers offer — the pool the router draws from, benchmarked and ranked."
- Routing Profiles: "Three virtual models — Lite, Pro, Max — that route each request to the best model in the pool."
...
- Titlebar icon (15 px) and sidebar brand mark (19 px on the accent square) use `mark-16`.
- The About heading (31x28 px) uses `mark-32`.
- Inline glyphs crop the viewBox to the artwork (`96 96 320 320` for mark-16, `80 96 352 320` for mark-32).
